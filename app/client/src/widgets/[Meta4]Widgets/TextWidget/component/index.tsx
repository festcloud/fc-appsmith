...
import { OverflowTypes, typographyVariants } from "../constants";
...
export const StyledText = styled(Text)<StyledTextProps>`
  ...
  font-family: ${({typography}) =>
    typographyVariants[typography].fontFamily};
  font-weight: ${({typography}) =>
    typographyVariants[typography].fontWeight || 400};
  font-size: ${({ typography }) =>
    typographyVariants[typography].fontSize || DEFAULT_FONT_SIZE};
  font-style: ${({ typography }) =>
    typographyVariants[typography].fontStyle || "normal"};
  line-height: ${({ typography }) =>
    typographyVariants[typography].lineHeight};
...
class TextComponent extends React.Component<TextComponentProps, State> {
  ...
  render() {
    ...
    return (
      <>
        <TextContainer
          fontFamily={typographyVariants[typography].fontFamily}
        >
          <StyledText
